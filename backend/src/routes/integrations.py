    ...
    try:
        ...
        chatflows = [
            ...
            },
            {
                ...
                'use_cases': ['Material recommendations', 'Supplier suggestions', 'Cost optimization']
            },
            {
                'id': 'project-planner',
...
def receive_flowise_feedback():
    ...
    try:
        ...
        return jsonify({
            'success': True,
            'message': 'Flowise feedback processed successfully'
        })
    ...
    try:
        ...
        return jsonify({
            ...
            'status': {
                ...
                'overall': 'healthy' if n8n_status['healthy'] and flowise_status['healthy'] else 'degraded'
            },
...
def configure_automation():
    ...
    try:
        ...
        trigger_workflow_update('user_preferences_updated', {
            'user_id': current_user.id,
