...
def get_notification_stats():
    ...
    try:
        ...
        if user_id:
            ...
            total_unread = db.session.query(Notification).filter(
                Notification.is_read == False
            ).count()
            ...
            return jsonify({
                ...
                'platform_stats': {
                    ...
                    'read_rate_percent': round((total_notifications - total_unread) / total_notifications * 100, 2) if total_notifications > 0 else 0
                }
            })
