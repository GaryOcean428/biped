    ...
    try:
        ...
        response = {
            ...
            'suggestions': {
                ...
                'timeline_recommendation': _recommend_timeline(analysis['urgency'], analysis['complexity'])
            }
        }
...
def _generate_title_suggestions(analysis):
    ...
    if 'electrical' in skills:
        if complexity == 'simple':
            suggestions.extend(['Electrical Outlet Installation', 'Light Fixture Replacement', 'Switch Repair'])
        elif complexity == 'complex':
            suggestions.extend(['Complete Home Rewiring', 'Electrical Panel Upgrade', 'Smart Home Installation'])
        else:
    ...
    if 'plumbing' in skills:
        if complexity == 'simple':
            ...
            suggestions.extend(['Bathroom Renovation Plumbing', 'Pipe Replacement', 'Water Heater Installation'])
        else:
