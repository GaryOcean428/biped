...
def create_invoice():
    ...
    try:
        ...
        trigger_n8n_workflow('invoice_created', {
...
def send_invoice(invoice_id):
    ...
    try:
        ...
        trigger_n8n_workflow('send_invoice_email', {
            'invoice_id': invoice.id,
            'client_email': invoice.client_email,
...
def get_expenses():
    ...
    try:
        ...
        tax_deductible_amount = sum(expense.amount for expense in expenses.items if expense.is_tax_deductible)
...
def create_expense():
    ...
    try:
        ...
        expense = Expense(
            ...
            is_tax_deductible=ai_analysis.get('is_tax_deductible', data.get('is_tax_deductible', True)),
