...
from ..utils.redis_client import publish_notification, redis_client
    ...
    try:
        ...
        for participant_id in participants:
            if participant_id != sender_id:
                ...
                redis_client.publish_notification(
                    f"user_{participant_id}",
                    {"type": "job_update", "message": message, "job_id": job_id},
                )
