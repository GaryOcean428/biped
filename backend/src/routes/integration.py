...
import requests
import os
from src.models import db, User, CustomerProfile, ProviderProfile
...
REACTCRM_URL = os.environ.get('REACTCRM_URL', 'https://reactcrm-production.up.railway.app')
EMAIL_SERVICE_URL = os.environ.get('EMAIL_SERVICE_URL', 'https://email-service.up.railway.app')
    ...
    try:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return jsonify({'error': 'CRM sync failed', 'status': response.status_code}), 500
    ...
    try:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return jsonify({'error': 'Email send failed', 'status': response.status_code}), 500
