...
def batch_analyze():
    ...
    try:
        ...
        if successful_analyses:
            avg_quality = sum(r['quality_score'] for r in successful_analyses) / len(successful_analyses)
        ...
        summary = {
            ...
            'overall_grade': _get_quality_grade(avg_quality / 100) if avg_quality > 0 else 'Unknown'
        }
...
def safety_inspection():
    ...
    try:
        ...
        response = {
            ...
            'critical_violations': [issue for issue in safety_data.get('issues', []) 
