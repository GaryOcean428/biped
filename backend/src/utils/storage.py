    ...
    def get_storage_info(self) -> dict:
        ...
        try:
            ...
            return {
                ...
                "directories": {
                    "uploads": len(os.listdir(self.uploads_dir)) if os.path.exists(self.uploads_dir) else 0,
                    "logs": len(os.listdir(self.logs_dir)) if os.path.exists(self.logs_dir) else 0,
                    "backups": len(os.listdir(self.backups_dir)) if os.path.exists(self.backups_dir) else 0
                }
            }
        except Exception as e:
