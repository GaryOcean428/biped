...
class SecurityEnhancer:
    ...
    def authenticate_user(self, email: str, password: str, ip_address: str) -> Tuple[Optional[dict], Optional[str]]:
        ...
        if attempts >= self.config.max_login_attempts:
            ...
            self.redis_client.set_cache(
                lockout_key, 
                True, 
                ttl=int(self.config.lockout_duration.total_seconds())
            )
