...
class ErrorHandler:
    ...
    def handle_validation_error(error_message: str) -> Tuple[Dict[str, Any], int]:
        ...
        return ErrorHandler.create_error_response(error_message, 400, "validation_error")
    ...
    def handle_authentication_error(
        ...
        return ErrorHandler.create_error_response(error_message, 401, "authentication_error")
    ...
    def handle_authorization_error(
        ...
        return ErrorHandler.create_error_response(error_message, 403, "authorization_error")

    @staticmethod
    def handle_not_found_error(resource: str = "Resource") -> Tuple[Dict[str, Any], int]:
        """Handle not found errors"""
        return ErrorHandler.create_error_response(f"{resource} not found", 404, "not_found_error")
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            try:
                ...
                return (
                    jsonify(ErrorHandler.handle_server_error("An unexpected error occurred")[0]),
                    500,
                )
