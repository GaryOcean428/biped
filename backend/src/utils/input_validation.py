...
class InputValidator:
    ...
    def validate_phone(phone: str) -> bool:
        ...
        return bool(
            au_mobile or au_landline or InputValidator.PHONE_PATTERN.match(cleaned)
        )
    ...
    def validate_job_budget(
        budget_min: Union[int, float], budget_max: Union[int, float]
    ) -> bool:
...
def validate_and_sanitize(
    data: Dict[str, Any], validation_type: str = "general"
) -> Dict[str, Any]:
    ...
    if validation_type == "job_posting":
        ...
        return {"valid": True, "errors": {}, "sanitized_data": sanitized}
