...
def create_app():
    ...
    # Configuration - Use secure random secret if not provided
    ...
    app.socketio = socketio  # Store reference for later use
        ...
        try:
            ...
            if not Admin.query.filter_by(username="admin").first():
                ...
                if not admin_password:
                    ...
                    logger.warning(
                        "⚠️ ADMIN_PASSWORD not set. Generated random password. Set ADMIN_PASSWORD environment variable for production."
                    )
    ...
    # Register blueprints
    try:
        from src.routes import admin_bp, auth_bp, dashboard_bp, health_bp, jobs_bp
