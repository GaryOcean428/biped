...
class Payment(db.Model):
    ...
    # Payment status
    status = db.Column(db.String(50), default='pending')  # pending, paid, transferred, refunded, disputed
...
class Dispute(db.Model):
    ...
    status = db.Column(db.String(50))  # warning_needs_response, warning_under_review, warning_closed, etc.
