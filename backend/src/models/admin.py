...
class Admin(db.Model):
    ...
    def generate_session_token(self):
        ...
        self.session_expires = datetime.utcnow().replace(hour=23, minute=59, second=59, microsecond=999999)
    ...
    def get_default_permissions(self):
        ...
        if self.role == 'super_admin':
            return [
                'user_management', 'service_management', 'job_management',
                'review_management', 'payment_management', 'analytics',
                'admin_management', 'system_settings'
            ]
        else:
            return [
                'user_management', 'service_management', 'job_management',
                'review_management', 'analytics'
            ]
