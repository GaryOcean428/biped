...
class Job(db.Model):
    ...
    assigned_provider = db.relationship('User', foreign_keys=[assigned_provider_id], backref='assigned_jobs')
    ...
    def to_dict(self):
        return {
            ...
            'provider_name': self.assigned_provider.get_full_name() if self.assigned_provider else None
        }
...
class Quote(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'provider_rating': self.provider.provider_profile.average_rating if self.provider and self.provider.provider_profile else None
        }
