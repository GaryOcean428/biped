...
def populate_services():
    ...
    with app.app_context():
        ...
        services_data = [
            ...
            {'category_id': 1, 'name': 'Tap Installation', 'slug': 'tap-installation', 'description': 'Install or repair taps and faucets', 'typical_price_min': 100, 'typical_price_max': 250, 'price_unit': 'job', 'typical_duration_hours': 1.5},
